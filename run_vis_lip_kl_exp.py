...
def main():
    ...
    parser.add_argument('--num_components', type=int, default=16, help='Number of Gaussian components')
    ...
    parser.add_argument('--rgm_std', type=float, default=0.001, help='Std for Gaussian components')
